...
%                         xlabel(cbh(ii),'$b$','interpreter','latex','fontsize',18)
%                     end
%                 end
                hold on
        ...
        print('-dpng','-r200',['figures/n2_',tag,'_',num2str(ifig,'%02i')])
    end
end
