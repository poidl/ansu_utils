...
grid on
legend([p1 p2 p3 p4 p5 p6 p7 p8],{'b=1: \epsilon','b=1: \Phi','b variable: \epsilon',...
    'b variable: \Phi','b=1, better starting surf.: \epsilon','b=1, better starting surf.: \Phi', 'b variable, better starting surf.: \epsilon','b variable, better starting surf.: \Phi'});
title('helicity spike')
xlabel('Iterations')
ylabel('$\rm kg/m^{-3}$','interpreter','latex','fontsize',13)
axis tight
print('-dpdf','-r200',['figures/compare_drho_rms_new_start_hel'])