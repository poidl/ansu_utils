...
fname='../exp337/data/iteration_history.mat';
...
fname='../exp340/data/iteration_history.mat';
load(fname,'drho_rms_hist','epsilon_rms_hist');
amp2=drho_rms_hist; 
...
text(-0.17,1.05,['a)'],'units','normalized','fontsize',12)
...
text(-0.17,1.05,['b)'],'units','normalized','fontsize',12)
...
%axis tight
print('-dpdf','-r200',['figures/gamma_error_isobar_bvert'])
