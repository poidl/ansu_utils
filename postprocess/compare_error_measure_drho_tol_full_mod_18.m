...
fname='../exp293/data/iteration_history.mat';
...
fname='../exp294/data/iteration_history.mat';
load(fname,'drho_rms_hist','drhoxy_rms_hist' );
v260_1=drho_rms_hist; 
v260_2=drhoxy_rms_hist;

fname='../exp295/data/iteration_history.mat';
load(fname,'drho_rms_hist','drhoxy_rms_hist' );
v270_1=drho_rms_hist; 
v270_2=drhoxy_rms_hist;

fname='../exp296/data/iteration_history.mat';
load(fname,'drho_rms_hist','drhoxy_rms_hist' );
...
axis tight
print('-dpdf','-r200',['figures/compare_drho_rms_tol_full_mod_18'])