...
% lo1=find(longs>290,1,'first');
% lo2=find(longs<360,1,'last');
% la1=find(lats>57,1,'first');
% 
% sa(:,la1:end,lo1:lo2)=nan;
% ct(:,la1:end,lo1:lo2)=nan;
% p(:,la1:end,lo1:lo2)=nan;

[longs,lats] = meshgrid(longs,lats);

% h=imagesc(squeeze(sa(1,:,:)))
%         set(gca,'YDir','normal')
%         set(h,'alphadata',~isnan(sa))
%         colorbar
...
%dbstop in optimize_surface_exact at 10


% load('../exp243/data/iteration_history.mat','pns_hist');
