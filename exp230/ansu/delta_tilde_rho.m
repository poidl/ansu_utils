function [drhodx,drhody, drhody_p] = delta_tilde_rho(sns,ctns,pns)
...
drhody_p=(gsw_rho( circshift(sns(:,:), [-1 0])  , circshift( ctns(:,:), [-1 0]) ,pmid+1)-gsw_rho(sns(:,:),ctns(:,:),pmid+1));
drhody_p=drhody_p-drhody;
drhody_p(yi,:) = nan;
