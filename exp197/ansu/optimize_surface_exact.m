...
while it<=nit;
    ...
    % just for run197 (see diary)??  disregard data above mixed layer depth. Need this
    % for the first iteration, otherwise data in the mixed layer is
    % included in the mean pressure
