...
while it<=nit;
    ...
    if save_iterations;
        ...
        diagnose_and_write_before_wetting(it,sns,ctns,pns,phiprime);
    end
    ...
    % diagnose
    if save_iterations;
        diagnose_and_write_after_wetting(it,ex,ey);
    end
...
function diagnose_and_write_before_wetting(it,sns,ctns,pns,phiprime_e)
...
function diagnose_and_write_after_wetting(it,ex,ey)
user_input; % read nit, etc.
