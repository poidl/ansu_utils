...
while it<=nit;
    ...
    if save_iterations;
        ...
        diagnose_and_write(it,sns,ctns,pns,drho,b);
    end
...
function diagnose_and_write(it,sns,ctns,pns,drho,b)
...
if it==0 % initialize
    ...
    vars = {'sns_hist','ctns_hist','pns_hist','drho_rms_hist','drho_hist','b_hist'};
